...
public partial class SpecificObjectsCoverage
{
    ...
    public static void TestBody()
    {
        ...
        Body Body5 = NodeHelper.CreateInitializedBody(typeof(DeferredBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList);
        ...
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(DeferredBody), NullDocument, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(DeferredBody), Document, NullRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(DeferredBody), Document, EmptyRequireBlockList, NullEnsureBlockList, EmptyExceptionIdentifierBlockList); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(DeferredBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, NullExceptionIdentifierBlockList); });
#endif
        ...
        Body Body6 = NodeHelper.CreateInitializedBody(typeof(EffectiveBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, EmptyEntityDeclarationBlockList, EmptyInstructionBlockList, EmptyExceptionHandlerBlockList);
        ...
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(EffectiveBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, NullEntityDeclarationBlockList, EmptyInstructionBlockList, EmptyExceptionHandlerBlockList); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(EffectiveBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, EmptyEntityDeclarationBlockList, NullInstructionBlockList, EmptyExceptionHandlerBlockList); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(EffectiveBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, EmptyEntityDeclarationBlockList, EmptyInstructionBlockList, NullExceptionHandlerBlockList); });
#endif

        Body Body7 = NodeHelper.CreateInitializedBody(typeof(ExternBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList);
        ...
        Body Body8 = NodeHelper.CreateInitializedBody(typeof(PrecursorBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, null, null, null, AncestorType);
        Assert.That(Body8 is PrecursorBody);

        CheckWrongTypeException("nodeType", typeof(Body), () => { NodeHelper.CreateInitializedBody(typeof(Identifier), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList); });

#if !DEBUG
        IOptionalReference<ObjectType> NullAncestorType = null!;

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedBody(typeof(PrecursorBody), Document, EmptyRequireBlockList, EmptyEnsureBlockList, EmptyExceptionIdentifierBlockList, null, null, null, NullAncestorType); });
#endif
    }
    ...
    public static void TestFeature()
    {
        ...
        Feature Feature8 = NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, EmptyEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed);
        Feature Feature9 = NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, DefaultExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed);
        Feature Feature10 = NodeHelper.CreateInitializedFeature(typeof(CreationFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed);
        Feature Feature11 = NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, null, OnceChoice.Normal, SimpleQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed);
        Feature Feature12 = NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed);
        Feature Feature13 = NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed);
        Feature Feature14 = NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, null, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, SimpleEntityDeclarationBlockList, ParameterEndStatus.Closed);

        CheckWrongTypeException("nodeType", typeof(Feature), () => { NodeHelper.CreateInitializedFeature(typeof(Identifier), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, null, null, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        CheckMustNotBeEmptyException("commandOverloadBlocks", () => { NodeHelper.CreateInitializedFeature(typeof(CreationFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, EmptyCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        CheckMustNotBeEmptyException("queryOverloadBlocks", () => { NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, null, OnceChoice.Normal, EmptyQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        CheckMustNotBeEmptyException("commandOverloadBlocks", () => { NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, EmptyCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        CheckMustNotBeEmptyException("indexParameterBlocks", () => { NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, null, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, EmptyEntityDeclarationBlockList, ParameterEndStatus.Closed); });
        ...
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, EmptyEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, EmptyEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, DefaultObjectType, EmptyEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, NullObjectType, NullEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(AttributeFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, NullEnsureBlockList, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, DefaultExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, DefaultExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, DefaultObjectType, null, DefaultExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, NullObjectType, null, DefaultExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ConstantFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, NullExpression, null, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(CreationFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(CreationFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(CreationFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(CreationFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, NullCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, null, OnceChoice.Normal, SimpleQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, null, OnceChoice.Normal, SimpleQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, null, null, null, null, OnceChoice.Normal, SimpleQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(FunctionFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, null, OnceChoice.Normal, NullQueryOverloadBlockList, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, null, null, null, SimpleCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(ProcedureFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, null, null, null, NullCommandOverloadBlockList, OnceChoice.Normal, null, UtilityType.ReadOnly, null, null, null, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, NullName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, NullObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, NullIdentifierBlockList, EmptyGetter, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, NullBodyReference, EmptySetter, null, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(PropertyFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, EmptyName, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, NullBodyReference, null, ParameterEndStatus.Closed); });

        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), NullDocument, EmptyExportIdentifier, ExportStatus.Exported, null, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, SimpleEntityDeclarationBlockList, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), EmptyDocument, NullExportIdentifier, ExportStatus.Exported, null, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, SimpleEntityDeclarationBlockList, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, null, NullObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, EmptyIdentifierBlockList, EmptyGetter, EmptySetter, SimpleEntityDeclarationBlockList, ParameterEndStatus.Closed); });
        Assert.Throws<ArgumentNullException>(() => { NodeHelper.CreateInitializedFeature(typeof(IndexerFeature), EmptyDocument, EmptyExportIdentifier, ExportStatus.Exported, null, DefaultObjectType, null, null, null, OnceChoice.Normal, null, UtilityType.ReadOnly, NullIdentifierBlockList, EmptyGetter, EmptySetter, SimpleEntityDeclarationBlockList, ParameterEndStatus.Closed); });
